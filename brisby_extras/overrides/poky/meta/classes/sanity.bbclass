...
def check_sanity_version_change(status, d):
    ...
    # macOS with default HFS+ file system). Skip when SANITY_SKIP_CASE_INSENSITIVE_FS=1 (e.g. containerized build on macOS).
    if d.getVar("SANITY_SKIP_CASE_INSENSITIVE_FS") != "1":
